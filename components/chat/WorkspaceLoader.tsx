...
export function WorkspaceLoader() {
  return (
    <div className="relative flex h-screen w-full items-center justify-center bg-gradient-to-b from-zinc-50 via-zinc-100 to-zinc-200 p-4 overflow-hidden">
      ...
      {/* Main Container Card */}
      <div className="relative flex h-[92vh] w-full max-w-4xl flex-col items-center justify-center rounded-[32px] border border-zinc-200/80 bg-white/60 shadow-[0_20px_50px_rgba(0,0,0,0.04)] backdrop-blur-2xl transition-all duration-500">
